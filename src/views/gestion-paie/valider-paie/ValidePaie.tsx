  ...
  useEffect(() => {
    heureSerivice
      ...
      .then((data) => {
        ...
        console.log('hsni130', calculHeuresEmploye.getHsni130())
        console.log('hsni150', calculHeuresEmploye.getHsni150())
        console.log('hsi130', calculHeuresEmploye.getHsi130())
        console.log('hsi150', calculHeuresEmploye.getHsi150())
