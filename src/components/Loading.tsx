...
const Loading = ({ width = 'w-8', height = 'h-8' }: LoadingProps) => (
  <div
    className={`inline-block animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite] ${width} ${height}`}
    role="status"
  >
